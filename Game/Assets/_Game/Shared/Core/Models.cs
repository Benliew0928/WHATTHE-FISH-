...
namespace SportsPrototype {
 ...
 public static class LocalProfile {
  ...
  public static StadiumAppearance ForSport(SportId sport)=>sport switch{SportId.Football=>Stadium,SportId.Basketball=>Basketball,SportId.Golf=>Golf,_=>throw new ArgumentOutOfRangeException(nameof(sport))};
  public static void SaveSport(SportId sport,StadiumAppearance value){switch(sport){case SportId.Football:Stadium=value;break;case SportId.Basketball:Basketball=value;break;case SportId.Golf:break;default:throw new ArgumentOutOfRangeException(nameof(sport));}}
